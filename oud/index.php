...
echo "Opgericht: 14-11-2015 <br /> Dagen sinds oprichting: ";
	$now = time();
     ...
     date_default_timezone_set('Europe/Amsterdam');  //Dit zodat localhost niet gaat zeuren, die heeft een timezone nodig
     ...
     if ($jsonArray['location']['name'] == 'Netherlands'){
     	echo "Locatie: Nederland <br />";
     } else {
     	echo "Locatie: " . $jsonArray['location']['name'] . "<br />";
     }
